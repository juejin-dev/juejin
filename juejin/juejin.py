...
class JuejinDriver:
    ...
    def run(self):
        ...
        for retry in range(self.retry):
            ...
            try:
                ...
                avatar = self.driver.find_element(
                    By.XPATH, "//li[@class='nav-item menu']/img")
                if avatar:
                    flag = True
                    break
        ...
        if flag is False:
            raise Exception(
                f"Verify slide image error and retry {self.retry}! ")
    ...
    def get_verify_image_url(self):
        ...
        verify_image1 = self.driver.find_element(
            By.XPATH, '''//img[@id="captcha-verify-image"]/../img[1]''')
        verify_image2 = self.driver.find_element(
            By.XPATH, '''//img[@id="captcha-verify-image"]/../img[2]''')
    ...
    def prepare_login(self):
        ...
        ActionChains(self.driver).move_to_element(
            other_login_span).click().perform()
        time.sleep(2)
